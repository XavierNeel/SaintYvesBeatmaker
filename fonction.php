...
function update_user($id_user, $login, $last_name, $first_name, $address, $city)
{
    ...
    $sql =  "UPDATE users
    SET login= '$login', last_name= '$last_name', first_name= '$first_name', address= '$address', city= '$city'
    WHERE id_user=$id_user";
    $sth = $connection->prepare($sql);
    $sth->execute();
}
